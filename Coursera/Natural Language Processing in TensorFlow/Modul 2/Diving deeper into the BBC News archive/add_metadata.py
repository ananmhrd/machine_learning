...
ntbk = nbf.read(f'/content/machine_learning/Coursera/Natural Language Processing in TensorFlow/Modul 2/Diving deeper into the BBC News archive/{args.filename}', nbf.NO_CONVERT)
